...
### Láthatóság projektszinten

A **Csapat kezelése → ✎** ablakban minden projekt egy dobozban jelenik meg. A doboz tetején lévő pipa (*A teljes projekt látható*) dönti el, hogy a munkatárs látja-e az egész projektet; alatta feladatonként is lehet finomítani.

- **Projekt bepipálva:** minden feladatát látja, kivéve amit alatta külön kivettél.
- **Projekt kipipálatlan:** a projekt eltűnik a bal oldali listájáról – kivéve azokat a feladatokat, amiket alatta külön engedélyeztél, vagy amik rá vannak osztva. Ilyenkor a projekt csak ezekkel a feladatokkal jelenik meg nála.

A tulajdonos oldalán a korlátozott projekt neve mellett 🔒 látszik.
...
- Feladat létrehozása, áthelyezése, határidő-, prioritás- vagy színmódosítás
- Új jegyzet, reakció, ellenőrzőlista-pont, feltöltött melléklet
- **Csevegőüzenet** – privát vagy csoportos, csak a beszélgetés résztvevőinek
...
- **Átrendezés (csak tulajdonos):** a feladatmezők a fejlécüknél fogva vízszintesen, a feladatcsoportok a bal oldali listában függőlegesen húzhatók át; telefonon nyomva tartás után
- **Csoportszínek:** minden feladatcsoport kaphat színt (bal oldalt a ✎ gombbal), ami a lista és a cím előtt jelenik meg
- **Húzd és ejtsd:** feladat áthelyezése egérrel, a tábla szélén automatikus gördüléssel
- **Időpontok:** a projekt fejlécében a létrehozás dátuma és pontos ideje; a feladat ablakának alján a létrehozás és az utolsó módosítás; a jegyzeteknél, mellékleteknél és csevegőüzeneteknél is pontos dátum és óra
...
- **Csevegés:** privát vagy csoportos, olvasatlan üzenetek számlálójával a fejlécben és e-mail értesítéssel
